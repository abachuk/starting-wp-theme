...
function optionsframework_load_sanitization() {
	require_once 'options-sanitize.php';
}
...
function optionsframework_init() {
	...
	require_once 'options-medialibrary-uploader.php';
...
function optionsframework_load_scripts($hook) {
	...
	wp_enqueue_script('options-custom', get_template_directory_uri() .'/admin/js/options-custom.js', array('jquery'));
